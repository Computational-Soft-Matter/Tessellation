...
int main() {
	string input_file = "sp9505exp";								// File contains the 3D coordinates of the colloidal particles
	string input_extension = ".vtk";
	string neighbor_input = "sp9505exppos.txt";								// If neighbor list has been calculated previously, then instead of NULL, the file will contain the index of a particle, number of neighbors and the radius of search to acquire those neighbors
